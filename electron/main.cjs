...
function createWindow() {
  ...
  // Also inject a standard User-Agent for Yahoo Finance to prevent 403 Forbidden errors
  mainWindow.webContents.session.webRequest.onBeforeSendHeaders(
    { urls: ['*://*.youtube.com/*', '*://*.youtube-nocookie.com/*', '*://*.googlevideo.com/*', '*://*.tradingview.com/*', '*://*.yahoo.com/*'] },
    (details, callback) => {
      ...
      } else if (details.url.includes('tradingview.com')) {
